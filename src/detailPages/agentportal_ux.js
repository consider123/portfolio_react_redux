            ...
            <Container>
                <Row>
                    <Col xs="12">
                        ...
                        <h3>MBO agent portal is a User interface which agents can use to help the customers with the presented benefits in thier account.
                            <br />Mastercard came with the brief of enabling the bank agents make changes, assign benefits, register customers using a protal which connects to the backend and applies the needful.
                            <br />
