                ...
                <Row>
                    <Col xs="12">
                        ...
                        <h3>Enhanced World Elite (EWE) is another loyalty platform which is similar to Mastercard's MBO program, difference being EWE covers the US market.
                            Idea was to provide an web interface through which the customers can manage, add and renew the available benefits. The requirement also pointed out the need of a fully working clickthough which mimics the actual website. This clickthorugh was required to help the agents demonstrate the product and sell it the the Banking clients.
                        </h3>
                ...
                <Row>
                    ...
                    <Col sm="7" lg="8">
                        ...
                        <ul className="custom">
                            ...
                            <li>A rapid protoype delivery which works offline as well and without any backend dependency.</li>
