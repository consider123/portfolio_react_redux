            ...
            <Container>
                <Row>
                    <Col xs="12">
                        ...
                        The goal was to provide a customizabe user interface where the authorized customers can add buy or/and renew the available loyalty benefits.</h3>
            ...
            <Container>
                <Row>
                    ...
                    <Col sm="7" lg="8">
                        <h2>Activities</h2>
                        <ul className="custom">
                            <li>Involved in techical analysis, business requirements analysis, technology decisions etc.</li>
